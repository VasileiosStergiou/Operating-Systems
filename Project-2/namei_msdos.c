				   ...
				   unsigned int flags)
{
	...
	struct inode *inode;
	int err;
	printk(KERN_INFO "file: namei_msdos.c msdos_lookup START\n");
	...
	printk(KERN_INFO "file: namei_msdos.c msdos_lookup END\n");
			...
			bool excl)
{
	...
	printk(KERN_INFO "file: namei_msdos.c msdos_create START\n");
	mutex_lock(&MSDOS_SB(sb)->s_lock);
...
out:
	...
	printk(KERN_INFO "file: namei_msdos.c msdos_create END\n");
	return err;
}
...
static int msdos_rmdir(struct inode *dir, struct dentry *dentry)
{
	...
	printk(KERN_INFO "file: namei_msdos.c msdos_rmdir START\n");
	mutex_lock(&MSDOS_SB(sb)->s_lock);
	/*
...
out:
	...
	if (!err)
		err = fat_flush_inodes(sb, dir, inode);
	printk(KERN_INFO "file: namei_msdos.c msdos_rmdir END\n");
	return err;
}
...
static int msdos_mkdir(struct inode *dir, struct dentry *dentry, umode_t mode)
{
	...
	printk(KERN_INFO "file: namei_msdos.c msdos_mkdir START\n");
	mutex_lock(&MSDOS_SB(sb)->s_lock);
...
static int msdos_unlink(struct inode *dir, struct dentry *dentry)
{
	...
	struct fat_slot_info sinfo;
	int err;
	printk(KERN_INFO "file: namei_msdos.c msdos_unlink START\n");
	mutex_lock(&MSDOS_SB(sb)->s_lock);
	err = msdos_find(dir, dentry->d_name.name, dentry->d_name.len, &sinfo);
	if (err)
		goto out;
...
out:
	...
	if (!err)
		err = fat_flush_inodes(sb, dir, inode);
	printk(KERN_INFO "file: namei_msdos.c msdos_unlink END\n");
	return err;
}
			...
			unsigned int flags)
{
	...
	printk(KERN_INFO "file: namei_msdos.c msdos_rename START\n");
...
out:
	...
	printk(KERN_INFO "file: namei_msdos.c msdos_rename END\n");
	return err;
}
...
{
	printk(KERN_INFO "file: namei_msdos.c setup START\n");
...
{	
	printk(KERN_INFO "file: namei_msdos.c fat_fill_super START\n");
...
static struct dentry *msdos_mount(struct file_system_type *fs_type,
			...
			void *data)
{	
	printk(KERN_INFO "file: namei_msdos.c mount_bdev START");
